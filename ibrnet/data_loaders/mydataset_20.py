...
class MyDataset_20(Dataset):
    def __init__(self, args, subset, scenes=None, **kwargs):

        self.folder_path = os.path.join(args.rootdir, 'data/mydataset_20/')
        ...
        for scene in self.scenes:
            ...
            # self.all_rgb_files.extend(rgb_files[:20])
...
class MyRenderDataset_20(Dataset):
