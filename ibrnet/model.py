...
class IBRNetModel(object):
    def __init__(self, args, load_opt=True, load_scheduler=True):
        ...
        self.learnable_params = list(self.net_coarse.parameters())
        self.learnable_params += list(self.feature_net.parameters())
        if self.net_fine is not None:
            self.learnable_params += list(self.net_fine.parameters())
