...
def config_parser():
    ...
    parser.add_argument('--seg_fc_hidden_layers', type=int, default=0, help='the number of hidden layers in the segmentation fully connection network')
    ...
    parser.add_argument("--n_iters", type=int, default=200000, help='num of iterations')
    parser.add_argument("--grad_weight", type=float, default=0.01, help='Normal loss weight')
    parser.add_argument("--seg_weight", type=float, default=1e-5, help='Normal loss weight')
